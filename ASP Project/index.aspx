<%@ Page Title="" Language="C#" MasterPageFile="~/project.Master" AutoEventWireup="true" CodeBehind="index.aspx.cs" Inherits="ASP_Project.index" %>
                            ...
                            <div class="col-xl-6 col-lg-7 col-md-12">
                                <div class="hero__caption">
                                    ...
                                    <p data-animation="fadeInLeft" data-delay="0.4s">
                                        ...
                                        certificates, and degrees online from world-class universities and companies
                                    </p>
                                    <!--a href="register.aspx" class="btn hero-btn" data-animation="fadeInLeft" data-delay="0.7s">Join 
                                        for Free</!--a-->
                                </div>
                            </div>
                        </div>
                ...
                <div class="row justify-content-center">
                    <div class="col-xl-12">
                        <div class="section-tittle text-center mt-20">
                            ...
                            <a href="Quiz.aspx" class="border-btn">Take Quiz</a>
                        </div>
                    </div>
                </div>
            </div>
